...
#[cfg(test)]
mod tests {
    use super::{FailedFile, HistoryEntry, HistoryStatus};
    use crate::config::{LosslessFormat, Mode};

    pub fn test_entry(index: usize) -> HistoryEntry {
        HistoryEntry {
            ...
            mode: Mode::Compat,
            lossless_format: Some(LosslessFormat::Wav),
            new_count: 1,
            existing_count: 0,
            skipped_count: 0,
            error_count: 0,
    ...
    pub fn test_entry_with_failure(path: &str, message: &str) -> HistoryEntry {
